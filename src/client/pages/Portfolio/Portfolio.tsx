    ...
    <div className="background background__portfolio">
      ...
      <div className="pt-3 container">
        <div className="row align-items-center">
          ...
          <button onClick={() => setExpandAll(!expandAll)} className="btn btn-outline-darkinfo ml-5">
            {!expandAll ? "Show All Details" : "Hide All Details"}
          </button>
        </div>
...
const ProjectSummary: React.FC<IProjectSummaryProps> = ({ project, expand }) => {
  ...
  return (
    <div className="my-2 border-info card" style={{ backgroundColor: "rgba(255, 255, 255, 0.75)" }}>
      <div className="card-header">
        <div className="px-3 row">
          ...
          <button
            ...
            className="ml-auto align-self-center btn btn-outline-primary"
          >
      ...
      <div className="card-footer">
        <div className="row">
          <a href={project.gitHubLink} title="Source Code">
            <FontAwesomeIcon icon={faGithub} size="3x" className="mx-2" />
          </a>
          {project.siteLink ? (
            <a href={project.siteLink} title="Live Site">
              <FontAwesomeIcon icon={faGlobe} size="3x" className="mx-2" />
            </a>
          ) : (
            <div className="mx-2 text-center" style={{ height: 42, width: 42, fontSize: 12 }}>
              Link coming soon
            </div>
          )}
        </div>
