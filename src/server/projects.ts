...
export const projects: Project[] = [
    {
        ...
        infoList: ["Full-stack functional blog site with connected SQL DB (also connected to a mobile app that may be deployed later)",
        ...
        siteLink: 'http://wills-blogs.herokuapp.com',
    },
    {
        id: 2,
        name: 'Orifin Prototype (in progress)',
        infoList: ["Full-stack site for a small business starting a technology facility with the intent to expand nationally in the coming years",
